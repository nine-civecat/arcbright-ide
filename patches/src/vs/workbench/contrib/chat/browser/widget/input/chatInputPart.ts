...
export class ChatInputPart extends Disposable implements IHistoryNavigationWidget {
	...
	*/
	...
	private _getAriaLabel(): string {
		...
		if (verbose) {
			return kbLabel
				? localize('actions.chat.arcbrightAccessibiltyHelp', "Ask Arcbright(玄明) {0}{1} Press Enter to send out the request. Use {2} for Chat Accessibility Help.", modeLabel, modelInfo, kbLabel)
				: localize('chatInput.arcbrightAccessibilityHelpNoKb', "Ask Arcbright(玄明) {0}{1} Press Enter to send out the request. Use the Chat Accessibility Help command for more information.", modeLabel, modelInfo);
		} else {
			return localize('chatInput.arcbrightAccessibilityHelp', "Ask Arcbright(玄明) {0}{1}.", modeLabel, modelInfo);
		}
	}
	...
	render(container: HTMLElement, initialValue: string, widget: IChatWidget) {
		...
		this.container.classList.add('arcbright-input-part');

		// ArcBright CSS variables for dark theme
		...
		// ArcBright input styling
		inputContainer.classList.add('arcbright-input');
