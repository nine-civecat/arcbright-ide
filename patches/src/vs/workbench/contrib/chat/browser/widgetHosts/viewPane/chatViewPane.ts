...
export class ChatViewPane extends ViewPane implements IViewWelcomeDelegate {
	...
	protected override renderBody(parent: HTMLElement): void {
		...
		this.viewPaneContainer.classList.add('arcbright-chat');
		this.viewPaneContainer.style.setProperty('--arcbright-void', '#08090a');
		this.viewPaneContainer.style.setProperty('--arcbright-s1', '#0f1011');
		this.viewPaneContainer.style.setProperty('--arcbright-s2', '#191a1b');
		this.viewPaneContainer.style.setProperty('--arcbright-s3', '#222326');
		this.viewPaneContainer.style.setProperty('--arcbright-jade', '#18a058');
		this.viewPaneContainer.style.setProperty('--arcbright-border', 'rgba(255,255,255,0.06)');
		this.viewPaneContainer.style.setProperty('--arcbright-tx', '#f7f8f8');
		this.viewPaneContainer.style.setProperty('--arcbright-tx2', '#a0a4ac');
		this.viewPaneContainer.style.setProperty('--arcbright-tx3', '#6b6f78');
		this.viewPaneContainer.style.setProperty('--arcbright-cin', '#d03050');
		this.viewPaneContainer.style.setProperty('--arcbright-amb', '#f0a020');
		this.viewPaneContainer.style.setProperty('--arcbright-cy', '#2080f0');
		this.viewPaneContainer.style.setProperty('--arcbright-jg', 'rgba(24,160,88,0.12)');
